...
class buildClass extends State<screen1>{
 ...
 Widget build(BuildContext context){
    return Scaffold(
      ...
      body:
          // Image.network("https://www.netsolutions.com/insights/wp-content/uploads/2021/05/Does-Your-App-Have-a-Natural-Audience.webp"),
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Text("Welcome",style: TextStyle(color: Colors.green,
              fontSize: 50),
              ),
              Text("Create a new account",style: TextStyle(color: Colors.green,fontSize: 15, )),
